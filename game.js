...
const humorModal=document.getElementById("humor-modal"),humorForm=document.getElementById("humor-form"),humorNext=document.getElementById("humor-next"),humorAudio=document.querySelector(".humor-audio");
