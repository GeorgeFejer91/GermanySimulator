...
const assetSources={merkelSprite:"./assets/merkel-sprite.png?v=20260922-biomech4",bayernSprite:"./assets/bayern-walker-sprite.png?v=20260922-biomech4",aliceSprite:"./assets/alice-weidel-sprite.png?v=20260922-biomech4",borderPourerSprite:"./assets/border-pourer-sprite.png?v=20260922-biomech4",towelManSprite:"./assets/crowd-towel-man.png?v=20260922-biomech4",towelWomanSprite:"./assets/crowd-towel-woman.png?v=20260922-biomech4"};
...
const AUDIO_CLASS=Object.freeze({TEXT:"audio-text",BACKGROUND:"background-music",EFFECT:"sound-effect"}),STIMULUS_PRIORITY=Object.freeze({AMBIENT:1,REACTIVE:2,FEATURED:3,CRITICAL:4}),AUDIO_MIX=Object.freeze({FOREGROUND:1,BACKGROUND:.28,ATTACK_SECONDS:.12,RELEASE_SECONDS:.4,REQUIRED_GAP_MS:250,AMBIENT_GAP_MS:2500,AMBIENT_TTL_MS:4000});
...
function showFeaturedSpriteBark(n,family,item,nextItem){
 ...
 showWorldBark(n.name,line.text,false,line.recording||"","",{family,priority:STIMULUS_PRIORITY.FEATURED,ambient:false,isEligible:eligible,done:()=>{n.featuredAudioActive=false;if(eligible())showFeaturedSpriteBark(n,family,nextItem(),nextItem)}});return true
}
